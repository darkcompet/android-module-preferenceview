...
public class DkCheckBoxPreference extends TheBasePreference<DkCheckBoxPreference> {
	...
	public void init(Context context, DkPreference preference, DkPreferenceListener listener) {
		...
		this.checked = preference.getBoolean(key);
	}
	...
	public void decorateView(View view) {
		...
		if (enabled) {
			cbCheck.setOnCheckedChangeListener((buttonView, isChecked) -> {
				...
				preference.edit().putBoolean(key, isChecked).commitAsync();
	...
	public DkCheckBoxPreference summary(int sumaryTextId) {
		this.summaryTextId = sumaryTextId;
		return this;
	}

	public DkCheckBoxPreference summary(String summary) {
